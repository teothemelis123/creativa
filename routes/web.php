...
Route::get('/companies/show/{company}', [CompaniesController::class, 'show'])->name('companies.show');
...
Route::get('/employees/show/{employee}', [EmployeesController::class, 'show'])->name('employees.show');
